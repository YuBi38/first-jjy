...
<main class="w-50 mx-auto border round-5 p-5">
    ...
    <input type="text"  class="form-control" name="name" id="f_name" placeholder="이름을 입력해주세요">
    </div>
    </div>
    ...
    <input type="password" name="password2" class="form-control" id="f_password2" placeholder="비밀번호를 입력해주세요">
    </div>
    ...
    <input  type="text" name="zipcode" name="zipcode" readonly id="f_zipcode" class="form-control" maxlength="5" minlength="5">
    </div>
    ...
    <div class="mt-3 d-flex gap-5">
        <div>
            ...
            <input type="file" name="photo" id="f_photo" class="form-control" > </div>
